...
Begin VB.Form Tela_Pedido_MP 
   ...
   Begin VB.CommandButton BT_Imprimir 
      ...
      Height          =   855
      Left            =   2520
      Picture         =   "Tela_Pedido_MP.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   11
   ...
   Begin VB.CommandButton BT_Voltar 
      ...
      Height          =   855
      Left            =   4320
      Picture         =   "Tela_Pedido_MP.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   10
   ...
   End
End
Attribute VB_Name = "Tela_Pedido_MP"
...
Option Explicit
' ****************** DECLARAÇÕES ****************
Const NOMEAPLIC As String = "Pedido de Estoque - MP"
...
Public Static Sub DetalhesMP(QUA As String, FIG As String, BIT As String, MAT As String, DES As String)
    ...
    If Tela_Pedido.bCarregaPedido = False Then
        TelaEmEspera True
        Tela_Pedido.BP.Max = 5
        Tela_Pedido.BP.Value = 0
        Tela_Pedido.BP.Value = Tela_Pedido.BP.Value + 1
    End If
    ...
    sDescricao = DES
    If Tela_Pedido.bCarregaPedido = False Then Tela_Pedido.BP.Value = Tela_Pedido.BP.Value + 1
    MontaFG_MP
    If Tela_Pedido.bCarregaPedido = False Then Tela_Pedido.BP.Value = Tela_Pedido.BP.Value + 1
    LeMP
    If Tela_Pedido.bCarregaPedido = False Then Tela_Pedido.BP.Value = Tela_Pedido.BP.Value + 1
    ConsultaSaldo
    If Tela_Pedido.bCarregaPedido = False Then Tela_Pedido.BP.Value = Tela_Pedido.BP.Value + 1
    If Tela_Pedido.bCarregaPedido = False Then TelaEmEspera False
    If Tela_Pedido.bCarregaPedido = False Then Tela_Pedido.BP.Value = 0
End Sub
...
Private Static Sub LeMP()
    ...
    With Tela_Pedido.DLL_BD
        ...
        If Not .BDSIS_TBEST.NoMatch Then
            If IsEmpty(.BDSIS_TBEST_CPINQ.Value) = True Or IsNull(.BDSIS_TBEST_CPINQ.Value) = True Or _
               IsEmpty(.BDSIS_TBEST_CPINP.Value) = True Or IsNull(.BDSIS_TBEST_CPINP.Value) = True Or _
               IsEmpty(.BDSIS_TBEST_CPINN.Value) = True Or IsNull(.BDSIS_TBEST_CPINN.Value) = True Or _
               IsEmpty(.BDSIS_TBEST_CPINB.Value) = True Or IsNull(.BDSIS_TBEST_CPINB.Value) = True Or _
               IsEmpty(.BDSIS_TBEST_CPINM.Value) = True Or IsNull(.BDSIS_TBEST_CPINM.Value) = True Then
